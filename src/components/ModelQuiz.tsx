...
const InteractiveQuizModal: React.FC<InteractiveQuizModalProps> = ({ isOpen, onClose }) => {
  ...
  const shareOnTwitter = useCallback(() => {
    try {
      const tweetText = `I scored ${chillScore.toFixed(1)}% on the Chill-O-Meter! ${getChillMessage(chillScore)} How much Chill Guy are you? Find out now:https://chill-o-meter.vercel.app/  #ChillGuy`;
